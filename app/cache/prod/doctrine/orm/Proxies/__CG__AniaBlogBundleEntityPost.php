...
namespace Proxies\__CG__\Ania\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Post extends \Ania\BlogBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'slug', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'thumbnail', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'category', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'tags', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'author', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'createDate', '' . "\0" . 'Ania\\BlogBundle\\Entity\\Post' . "\0" . 'publishedDate');
        }
