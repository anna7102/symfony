...
class UserManager {
    ...
    public function sendResetPasswordLink($userEmail) {
        ...
        if(null === $User){
            throw new UserException('Aucun utilisateur ne correspond à votre recherche.');
        }
        ...
        $this->userMailer->send($User, 'Réinitialiser votre mot de passe', $emailBody);
    ...
    public function resetPassword($actionToken) {
        ...
        if(null === $User){
            throw new UserException('Paramètres incorrects.');
        }
        ...
        $this->userMailer->send($User, 'Nouveau mot de passe', $emailBody);
    ...
    public function registerUser(User $User) {
        ...
        if(null !== $User->getId()){
            throw new UserException('Cet utilisateur est déjà inscrit');
        }
        ...
        $this->userMailer->send($User, 'Activation de votre compte', $emaiBody);
    ...
    public function changePassword(User $User){
        ...
        if(null == $User->getPlainPassword()){
            throw new UserException('Mot de passe n\'a pas été défini!');
        }
